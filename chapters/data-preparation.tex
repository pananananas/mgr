...
% Placeholder for an example of generated prompts
% \begin{figure}[h]
%   \centering
%   \includegraphics[width=\textwidth]{images/data/sankey-diagram-objaverse-sources.png}
%   \caption{Examples of rendered views provided to Qwen2.5VL and the corresponding generated textual prompt. (Placeholder: Replace with actual examples.)}
%   \label{fig:prompt-generation-example}
% \end{figure}
...
\section{Final Dataset Characteristics}\label{sec:final-dataset-chars}
...
% Placeholder for a figure summarizing dataset statistics
% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.8\textwidth]{images/data/sankey-diagram-objaverse-sources.png}
%   \caption{Summary statistics of the final ObjaverseXL training dataset (e.g., number of models, views per model distribution, example prompts). (Placeholder: Replace with relevant charts/tables.)}
